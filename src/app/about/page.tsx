    ...
    return (
        <div className="max-w-4xl mx-auto px-4 py-16 min-h-screen">
            ...
            <div className="prose prose-invert max-w-none text-muted-foreground space-y-6">
                <section>
                    <h2 className="text-2xl font-bold text-white mt-8 mb-4">Who Runs OneList?</h2>
                    <p className="text-lg">
                ...
                <section>
                    <h2 className="text-2xl font-bold text-white mt-8 mb-4">How Links Are Curated</h2>
                    <p>
                ...
                <section>
                    <h2 className="text-2xl font-bold text-white mt-8 mb-4">Editorial Standards</h2>
                    <p>
