...
export const seoData: Record<string, SEOContent> = {
    ...
    'home_extended': {
        title: "Find Everything Free in One Place — OneList.pro",
        sections: [
            {
                heading: "Find Everything Free in One Place — OneList.pro",
                content: "Every day, millions of people search <a href=\"https://google.com\" target=\"_blank\" class=\"text-primary hover:underline\">Google</a>, <a href=\"https://yahoo.com\" target=\"_blank\" class=\"text-primary hover:underline\">Yahoo</a>, and <a href=\"https://search.brave.com\" target=\"_blank\" class=\"text-primary hover:underline\">Brave</a> for the same things — a good movie to watch tonight, a live football match, the latest anime episode, a new manga chapter, a song to add to their playlist, a free ebook to read before bed, or an AI tool to help finish work faster. The problem is not that this content doesn't exist for free. The problem is that it is scattered across hundreds of websites, most of which are hard to find, full of ads, or go offline without warning. OneList.pro was built to fix exactly that. We are a globally curated free streaming directory that organises the best working sites for <a href=\"/movies\" class=\"text-primary hover:underline\">movies</a>, <a href=\"/anime\" class=\"text-primary hover:underline\">anime</a>, <a href=\"/live-sports\" class=\"text-primary hover:underline\">sports</a>, <a href=\"/music\" class=\"text-primary hover:underline\">music</a>, <a href=\"/ebooks\" class=\"text-primary hover:underline\">ebooks</a>, <a href=\"/online-games\" class=\"text-primary hover:underline\">games</a>, <a href=\"/aitools\" class=\"text-primary hover:underline\">AI tools</a>, and more — all in one clean, updated place."
            },
            {
                heading: "20+ Categories of Hand-Curated Free Content",
                content: "Whether you want to <a href=\"/movies\" class=\"text-primary hover:underline\">watch free movies online</a> without signup, stream live sports like football, cricket, NBA, or F1 without a cable subscription, read <a href=\"/manga\" class=\"text-primary hover:underline\">manga and manhwa</a> chapters for free, discover the best <a href=\"/aitools\" class=\"text-primary hover:underline\">AI writing tools</a> and image generators, find working <a href=\"/torrents\" class=\"text-primary hover:underline\">torrent sites in 2026</a>, listen to music without paying for Spotify, watch <a href=\"/asian-drama\" class=\"text-primary hover:underline\">K-drama and Asian drama</a> with subtitles, download free ebooks and PDFs, or <a href=\"/online-games\" class=\"text-primary hover:underline\">play browser games</a> without installing anything — OneList has a dedicated, hand-curated category for every one of those needs. Our directory currently covers 20 categories including Movies and TV Shows, Anime, Manga, Live Sports, Live TV, Torrents, Games, Music, eBooks, Comics, Asian Drama, AI Tools, VPN, AdBlockers, Domain Registrars, Cartoons, Sports Replays, IPTV, Educational resources, and Downloading sites. Every link is manually verified before listing, and our team removes dead mirrors within 24 hours of going offline."
            },
            {
                heading: "Built for Everyday Users Worldwide",
                content: "Unlike overwhelming wiki-style directories such as <a href=\"https://fmhy.net\" target=\"_blank\" class=\"text-primary hover:underline\">FMHY</a> (freemediaheckyeah.net) or flat list sites like <a href=\"https://yarrlist.net\" target=\"_blank\" class=\"text-primary hover:underline\">Yarrlist</a>, OneList is built for everyday users — not just advanced internet users. Our card-based layout works perfectly on mobile, tablet, and desktop. You do not need a Reddit account, a Discord membership, or any technical knowledge to use it. Just open onelist.pro on any browser — Chrome, Firefox, Brave, or Safari — and find what you are looking for in seconds. We are indexed on Google Search, Yahoo, Bing, Brave Search, and DuckDuckGo so that wherever you search for free streaming sites, free anime, free sports streams, or free AI tools, you can find OneList. Our global audience spans the United States, United Kingdom, India, Australia, Canada, and Europe — with no geo-restrictions and no paywalls, ever."
            },
            {
                heading: "Safety as a Foundation, Not an Afterthought",
                content: "Safety is not an afterthought at OneList — it is the foundation. Many free streaming sites use aggressive ad scripts, pop-ups, and redirect links that can be harmful to your device. Before any site appears in our directory, we check it for malware, excessive redirects, and unstable domains. We also recommend that all visitors use a reliable <a href=\"/vpn\" class=\"text-primary hover:underline\">VPN</a> and a browser <a href=\"/adblockers\" class=\"text-primary hover:underline\">adblocker</a> such as uBlock Origin for an extra layer of protection. Our VPN directory and AdBlocker directory make it easy to find the right tools for safe browsing. Whether you visit us once a week or every single day, OneList is designed to be the first bookmark you open when you want to watch, read, listen, play, or discover something online — completely free."
            },
            {
                heading: "OneList.pro: Your Instant Access Hub",
                content: "Bookmark OneList.pro for instant access to: <a href=\"/movies\" class=\"text-primary hover:underline\">free movie streaming sites</a>, <a href=\"/anime\" class=\"text-primary hover:underline\">free anime streaming sites</a>, <a href=\"/live-sports\" class=\"text-primary hover:underline\">live sports streaming</a>, <a href=\"/live-tv\" class=\"text-primary hover:underline\">free live TV channels</a>, <a href=\"/torrents\" class=\"text-primary hover:underline\">torrent sites list 2026</a>, <a href=\"/online-games\" class=\"text-primary hover:underline\">free game download sites</a>, <a href=\"/music\" class=\"text-primary hover:underline\">free music streaming</a>, <a href=\"/ebooks\" class=\"text-primary hover:underline\">free ebook download sites</a>, <a href=\"/manga\" class=\"text-primary hover:underline\">free manga reading sites</a>, <a href=\"/comics\" class=\"text-primary hover:underline\">free comics online</a>, <a href=\"/asian-drama\" class=\"text-primary hover:underline\">best KDrama streaming sites</a>, <a href=\"/aitools\" class=\"text-primary hover:underline\">best AI tools 2026</a>, <a href=\"/vpn\" class=\"text-primary hover:underline\">free VPN recommendations</a>, <a href=\"/adblockers\" class=\"text-primary hover:underline\">best adblocker for streaming</a>, <a href=\"/educational-tools\" class=\"text-primary hover:underline\">free online courses and documentaries</a>, and direct download movie sites — all in one place, all free, all verified, all updated daily on <a href=\"/\" class=\"text-primary hover:underline font-bold\">OneList.pro</a>."
            }
        ]
    },
    'aitools': {
